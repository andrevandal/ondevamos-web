...
export interface ApiPlacePlace extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    slug: UIDAttribute<'api::place.place', 'title'> & RequiredAttribute
    avatar: MediaAttribute
    available: BooleanAttribute & RequiredAttribute & DefaultTo<false>
    medias: MediaAttribute
    description: StringAttribute
...
export interface ApiResourceResource extends CollectionTypeSchema {
  ...
  attributes: {
    slug: UIDAttribute<'api::resource.resource', 'title'> & RequiredAttribute
    title: StringAttribute & RequiredAttribute
