<template>
  <div class="flex flex-col gap-y-6">
    <form
      class="flex items-stretch justify-between before:rounded-lg p-[.2rem] before:absolute before:top-0 before:bottom-0 before:left-0 before:right-0 relative before:z-0 before:bg-gradient-to-r before:from-[#FBAD3F]/75 before:to-[#FF8157]/75 focus-within:before:before:from-[#FBAD3F]/90 focus-within:before:before:to-[#FF8157]/90 max-w-full mx-4"
    >
      <input
        type="search"
